...
const MESSAGES = [
  [
    ...
    'sarah@design.co',
    'Re: Q1 design review',
    "I've added comments to the figma file…",
  ...
  [
    ...
    'feat(dashboard): wire chart tabs',
    'Pull request #248 is ready for review.\n\n3 files changed, 47 additions, 12 deletions.'
  ],
  [
    'inbox',
    1,
    'work',
    'Stripe',
    'invoicing@stripe.com',
    'Your invoice is ready',
    'Invoice #INV-04812 for $499.00',
    'Invoice #INV-04812\nAmount: $499.00 USD\nDue: Apr 30, 2026'
  ],
  [
    'inbox',
  ...
  [
    ...
    'emily@design.co',
    'Sprint retro notes',
    'Posted the action items.',
    'Posted retro notes — three action items.'
  ],
  [
    'inbox',
    0,
    ...
    'You were assigned 3 issues',
    'GEN-128, GEN-129, GEN-131',
    'Three issues assigned to you.'
  ],
  [
    'inbox',
    0,
  ...
  [
    ...
    null,
    'Re: landing copy',
    'Two suggestions on the subhead…',
    'Two suggestions on the subhead.'
  ],
  [
    'trash',
    ...
    '90% off — today only',
    'Today only — 90% off.',
    'Today only — 90% off our top admin templates.'
  ]
];
