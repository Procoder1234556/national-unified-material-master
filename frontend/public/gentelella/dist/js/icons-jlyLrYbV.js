...
var t = [],
  a = document.getElementById('icon-content'),
  h = 0;
((a.innerHTML = Object.entries({
  'Navigation & layout': {
    ...
    external:
      '<path d="M14 3h7v7M21 3l-9 9"/><path d="M21 14v6a1 1 0 01-1 1H4a1 1 0 01-1-1V4a1 1 0 011-1h6"/>',
  ...
  'Account & people': {
    ...
    users:
      '<circle cx="9" cy="8" r="4"/><circle cx="17" cy="9" r="3"/><path d="M2 20c0-3.9 3.1-7 7-7s7 3.1 7 7M22 20c0-2.5-2-5-5-5"/>',
    user_plus:
      '<circle cx="9" cy="8" r="4"/><path d="M2 20c0-3.9 3.1-7 7-7s7 3.1 7 7"/><path d="M19 7v6M16 10h6"/>',
    user_check:
      '<circle cx="9" cy="8" r="4"/><path d="M2 20c0-3.9 3.1-7 7-7s7 3.1 7 7"/><path d="M16 10l2 2 4-4"/>',
    user_x:
      '<circle cx="9" cy="8" r="4"/><path d="M2 20c0-3.9 3.1-7 7-7s7 3.1 7 7"/><path d="M17 8l5 5M22 8l-5 5"/>',
    crown: '<path d="M3 18h18l-1.5-9-4 4L12 6l-3.5 7-4-4z"/>',
    award: '<circle cx="12" cy="9" r="6"/><path d="M9 14l-2 7 5-3 5 3-2-7"/>',
    shield_user:
      '<path d="M12 2l9 4v6c0 5-4 9-9 10-5-1-9-5-9-10V6z"/><circle cx="12" cy="11" r="2.5"/><path d="M8 17a4 4 0 018 0"/>',
    badge: '<circle cx="12" cy="9" r="5"/><path d="M9 13l-2 8 5-3 5 3-2-8"/>',
    contacts:
      '<rect x="3" y="4" width="18" height="16" rx="2"/><circle cx="9" cy="11" r="2.5"/><path d="M5 17c.6-1.7 2-3 4-3s3.4 1.3 4 3M15 8h4M15 12h4M15 16h2"/>'
  },
  'Files & data': {
    file: '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/>',
    file_text:
      '<path d="M14 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V8z"/><polyline points="14 2 14 8 20 8"/><path d="M9 13h6M9 17h6"/>',
    folder: '<path d="M3 7a2 2 0 012-2h4l2 2h7a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/>',
    folder_plus:
      '<path d="M3 7a2 2 0 012-2h4l2 2h7a2 2 0 012 2v9a2 2 0 01-2 2H5a2 2 0 01-2-2V7z"/><path d="M12 11v6M9 14h6"/>',
    archive:
      '<rect x="3" y="3" width="18" height="5" rx="1"/><path d="M5 8v11a2 2 0 002 2h10a2 2 0 002-2V8M9 13h6"/>',
    ...
    cloud_up:
      '<path d="M16 18a5 5 0 002-9.6A6 6 0 005 9a4 4 0 00-1 8h2"/><path d="M12 21v-9M9 15l3-3 3 3"/>',
    database:
      '<ellipse cx="12" cy="5" rx="9" ry="3"/><path d="M3 5v6c0 1.7 4 3 9 3s9-1.3 9-3V5M3 11v6c0 1.7 4 3 9 3s9-1.3 9-3v-6"/>',
    server:
      '<rect x="2" y="4" width="20" height="6" rx="2"/><rect x="2" y="14" width="20" height="6" rx="2"/><circle cx="6" cy="7" r="0.5" fill="currentColor"/><circle cx="6" cy="17" r="0.5" fill="currentColor"/>',
  ...
  Communication: {
    ...
    inbox:
      '<path d="M2 13l4-9h12l4 9"/><path d="M2 13v6a1 1 0 001 1h18a1 1 0 001-1v-6h-6l-2 3h-4l-2-3z"/>',
    ...
    phone:
      '<path d="M22 17v3a2 2 0 01-2.2 2 19.8 19.8 0 01-8.6-3.1 19.5 19.5 0 01-6-6 19.8 19.8 0 01-3.1-8.7A2 2 0 014.1 2h3a2 2 0 012 1.7c.1 1 .4 1.9.7 2.8a2 2 0 01-.4 2.1L8.1 9.9a16 16 0 006 6l1.3-1.3a2 2 0 012.1-.4c.9.3 1.8.6 2.8.7a2 2 0 011.7 2z"/>',
    video: '<rect x="2" y="6" width="13" height="12" rx="2"/><path d="M22 8l-7 4 7 4z"/>',
    headphones:
      '<path d="M3 18v-7a9 9 0 0118 0v7"/><path d="M21 19a2 2 0 01-2 2h-1v-6h3zM3 19a2 2 0 002 2h1v-6H3z"/>',
  ...
  Actions: {
    ...
    edit_pen:
      '<path d="M11 4H4a2 2 0 00-2 2v14a2 2 0 002 2h14a2 2 0 002-2v-7"/><path d="M18.5 2.5a2.1 2.1 0 113 3L12 15l-4 1 1-4z"/>',
    trash:
      '<path d="M3 6h18M8 6V4a2 2 0 012-2h4a2 2 0 012 2v2"/><path d="M6 6l1 14a2 2 0 002 2h6a2 2 0 002-2l1-14"/>',
    save: '<path d="M19 21H5a2 2 0 01-2-2V5a2 2 0 012-2h11l5 5v11a2 2 0 01-2 2z"/><polyline points="17 21 17 13 7 13 7 21"/><polyline points="7 3 7 8 15 8"/>',
    copy: '<rect x="9" y="9" width="11" height="11" rx="2"/><path d="M5 15V5a2 2 0 012-2h10"/>',
    duplicate:
      '<rect x="3" y="3" width="13" height="13" rx="2"/><path d="M19 8a2 2 0 012 2v9a2 2 0 01-2 2h-9a2 2 0 01-2-2"/>',
  ...
  Commerce: {
    ...
    dollar:
      '<line x1="12" y1="2" x2="12" y2="22"/><path d="M16 6H9.5a3.5 3.5 0 100 7h5a3.5 3.5 0 010 7H7"/>',
    credit_card:
  ...
  Tools: {
    ...
    paint:
      '<path d="M19 11H5a2 2 0 00-2 2v2a2 2 0 002 2h2v3a1 1 0 001 1h3a1 1 0 001-1v-3h7a2 2 0 002-2v-2a2 2 0 00-2-2z"/><path d="M19 11V5a2 2 0 00-2-2h-2a2 2 0 00-2 2v6"/>',
  ...
  'Calendar & time': {
    ...
    hourglass:
      '<path d="M5 3h14M5 21h14M7 3v3a5 5 0 005 5 5 5 0 005-5V3M7 21v-3a5 5 0 015-5 5 5 0 015 5v3"/>',
  ...
  'Visibility & state': {
    ...
    eye_off:
      '<path d="M3 3l18 18M10.5 6.4A11 11 0 0123 12s-2 4-6 6.5M6 6c-3 2-5 6-5 6s4 8 11 8c1.7 0 3.2-.4 4.5-1"/><path d="M9.5 9.5a3 3 0 004 4"/>',
    star: '<path d="M12 2l2.5 7.2 7.5.5-5.7 4.9 1.7 7.4L12 18l-6 3.7 1.7-7.4L2 9.7l7.5-.5z"/>',
    heart:
      '<path d="M12 21s-7-4.5-9-9.5C1.5 7.5 4.5 4 8 4c2 0 3.5 1 4 2 .5-1 2-2 4-2 3.5 0 6.5 3.5 5 7.5-2 5-9 9.5-9 9.5z"/>',
  ...
  'Web & links': {
    ...
    unlink:
      '<path d="M18.8 13.4L15 17a4 4 0 01-5.7-5.7l1-1M9.7 9.7l-1 1M5.2 10.6L9 7a4 4 0 015.7 5.7l-1 1M3 3l18 18"/>',
    share:
      '<circle cx="6" cy="12" r="3"/><circle cx="18" cy="6" r="3"/><circle cx="18" cy="18" r="3"/><path d="M9 11l6-4M9 13l6 4"/>',
    globe:
      '<circle cx="12" cy="12" r="10"/><path d="M2 12h20M12 2a14 14 0 010 20M12 2a14 14 0 000 20"/>',
  ...
  'Theme & weather': {
    ...
    cloud_rain:
      '<path d="M16 13a4 4 0 002-7.5A6 6 0 005 9a3 3 0 00-1 6h11"/><path d="M8 19v2M12 18v3M16 19v2"/>',
  ...
  Misc: {
    ...
    map_pin:
      '<path d="M12 21s-7-7-7-12a7 7 0 1114 0c0 5-7 12-7 12z"/><circle cx="12" cy="9" r="3"/>',
    map: '<polygon points="1 6 1 22 8 18 16 22 23 18 23 2 16 6 8 2 1 6"/><line x1="8" y1="2" x2="8" y2="18"/><line x1="16" y1="6" x2="16" y2="22"/>',
    compass: '<circle cx="12" cy="12" r="10"/><polygon points="16 8 14 14 8 16 10 10 16 8"/>',
    target:
      '<circle cx="12" cy="12" r="10"/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="2"/>',
    rocket:
      '<path d="M5 13c-3 0-3 4-3 4s4 0 4-3M9 19a7 7 0 01-3-3M14 5l5 5-9 9-5-5z"/><path d="M14 5l3-3a3 3 0 014 4l-3 3"/>',
  ...
  .map(
    ([a, c]) => (
      ...
      Object.keys(c).forEach(a => t.push(a)),
      `\n    <div class="icon-category">${a} <span style="opacity:.6;font-weight:400">· ${Object.keys(c).length}</span></div>\n    <div class="icon-grid">\n      ${Object.entries(
        c
      )
        .map(
          ([t, a]) =>
            `\n        <button type="button" class="icon-cell" data-name="${t}">\n          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5">${a}</svg>\n          <span>${t}</span>\n          <span class="copied">Copied!</span>\n        </button>\n      `
        )
        .join('')}\n    </div>\n  `
    )
  )
  .join('')),
  (document.getElementById('icon-count').textContent = `${h} icons`),
  a.addEventListener('click', async t => {
    const a = t.target.closest('.icon-cell');
    if (!a) return;
    const h = a.dataset.name;
    try {
      await navigator.clipboard.writeText(h);
    } catch (c) {}
    (a.classList.add('was-copied'), setTimeout(() => a.classList.remove('was-copied'), 900));
  }));
var c = document.getElementById('icon-search');
c.addEventListener('input', () => {
  const t = c.value.trim().toLowerCase(),
    e = a.querySelectorAll('.icon-cell');
  let l = 0;
  (e.forEach(a => {
    const h = !t || a.dataset.name.includes(t);
    ((a.style.display = h ? '' : 'none'), h && l++);
  }),
    a.querySelectorAll('.icon-category').forEach(t => {
      const a = t.nextElementSibling,
        h = [...a.querySelectorAll('.icon-cell')].some(t => 'none' !== t.style.display);
      ((t.style.display = h ? '' : 'none'), (a.style.display = h ? '' : 'none'));
    }),
    (document.getElementById('icon-count').textContent = `${l} of ${h} icons`));
});
