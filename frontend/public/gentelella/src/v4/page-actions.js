  ...
  showModal({
    ...
    actions: [
      { label: 'Discard', variant: 'ghost' },
      {
        label: 'Save draft',
        variant: 'outline',
        action: () => showToast('Draft saved', { variant: 'success' })
      },
      {
        label: 'Send',
        variant: 'primary',
        action: () => showToast('Message sent', { variant: 'success' })
      }
    ]
  });
}
  ...
  showModal({
    ...
    actions: [
      { label: 'Cancel', variant: 'ghost' },
      {
        label: 'Create',
        variant: 'primary',
        action: () => showToast(`${title} saved`, { variant: 'success' })
      }
    ]
  });
}
  ...
  showModal({
    ...
    actions: [
      { label: 'Cancel', variant: 'ghost' },
      {
        label: 'Send invite',
        variant: 'primary',
        action: () => showToast('Invite sent', { variant: 'success' })
      }
    ]
  });
}
...
export function initPageActions() {
  ...
  document.addEventListener('click', e => {
    ...
    if (btn.matches(SKIP_SELECTOR)) {
      return;
    }
    if (!btn.matches('.btn, .tb-btn')) {
      return;
    }
