...
function buildItems() {
  ...
  const actions = [
    { label: 'Toggle theme', keywords: 'theme dark light mode toggle', action: toggleTheme },
    {
      ...
      action: go(shellLink('profile', 'profile.html'))
    },
    {
      label: 'Open settings',
      keywords: 'settings preferences config',
      action: go(shellLink('settings', 'settings.html'))
    },
    {
      label: 'Theme generator',
      keywords: 'theme color customize brand',
      action: go(shellLink('theme', 'theme.html'))
    },
    {
      label: 'Help & support',
      keywords: 'help faq support docs',
      action: go(shellLink('help', 'faq.html'))
    },
    {
      label: 'Sign out',
