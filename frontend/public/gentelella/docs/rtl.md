...
**Vertical rotation is direction-neutral too.** A chevron that points _down_ when open should not be overridden for RTL; only the closed state, which points along the inline axis, needs mirroring.
