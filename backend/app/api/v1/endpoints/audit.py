...
async def get_audit_chain(
    ...
    """
    return default_cvc_audit_service.get_chain(limit=limit, offset=offset)
...
async def verify_chain():
    ...
    """
    return default_cvc_audit_service.verify_chain_integrity()
...
async def get_audit_stats():
    ...
    """
    return default_cvc_audit_service.get_stats()
...
async def export_cvc_dossier():
    ...
    """
    return default_cvc_audit_service.export_cvc_dossier()
